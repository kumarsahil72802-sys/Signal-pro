...
const SIGNAL_USE_FUTURES_CONTEXT = parseBooleanEnv(process.env.SIGNAL_USE_FUTURES_CONTEXT, true);
const SIGNAL_USE_REALTIME_CONTEXT = parseBooleanEnv(process.env.SIGNAL_USE_REALTIME_CONTEXT, true);
const SIGNAL_MIN_SIGNALS_PER_DAY = Math.max(0, parseNumberEnv(process.env.SIGNAL_MIN_SIGNALS_PER_DAY, 0));
